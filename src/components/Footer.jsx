        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Premium library study room booking platform designed for deep focus and collaborative excellence.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:hello@studynook.com" className="hover:text-primary transition-colors">hello@studynook.com</a>
              </li>
              <li className="flex items-center gap-2">
