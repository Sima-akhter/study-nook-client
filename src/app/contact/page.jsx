      ...
      <section className="py-20 bg-muted/20 border-b">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground">
            Have questions about StudyNook? Need help with a booking? Our support team is here to help you.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-1 space-y-8">
                ...
                <CardContent className="px-0 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-1">support@studynook.com</p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  ...
                  <Button variant="outline" size="icon" className="rounded-full">
                    <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.054 10.054 0 01-3.127 1.195 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
